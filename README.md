...
|---|---|---|
| **Django 5.2 (LTS)** | Framework completo: ORM, migraciones, admin, formularios y sistema de plantillas integrados; menos decisiones y menos código que ensamblar piezas sueltas. Se usa 5.2 y no 5.1 porque el entorno tiene Python 3.14, que 5.1 no soporta; 5.2 es además la versión LTS (soporte extendido). | Flask: microframework, habría que elegir e integrar ORM, migraciones y formularios a mano. |
...
|---|---|---|---|---|
| 1 | Elegir versión de Django | Crear proyecto con Django 5.1 y SQLite | Detectó que el entorno tiene Python 3.14, que Django 5.1 no soporta, y propuso Django 5.2 LTS | **Adaptado**: el plan original decía 5.1, pero se aceptó 5.2 porque instalar 5.1 habría fallado; 5.2 sigue siendo rama 5.x y además es LTS |
